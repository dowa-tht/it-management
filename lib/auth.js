...
export const TIER2_ROLES = ['approval', 'guest', 'member']
...
export const ROUTE_PERMISSIONS = {
  ...
  '/dashboard/profile':               ['administrator', 'supervisor', 'approval', 'member', 'guest'],
  '/dashboard/reports':               ['administrator', 'supervisor', 'approval', 'guest'],
  '/dashboard/incidents':             ['administrator', 'supervisor', 'approval', 'member', 'guest'],
  '/dashboard/backup':                ['administrator', 'supervisor', 'approval', 'guest'],
  '/dashboard/checklist':             ['administrator', 'supervisor', 'approval', 'guest'],
  '/dashboard':                       ['administrator', 'supervisor', 'approval', 'member', 'guest'],
}
...
export const ROLE_BADGE = {
  ...
  member:        { label: 'Member',        bg: '#eff6ff', color: '#1d4ed8', emoji: '👥' },
