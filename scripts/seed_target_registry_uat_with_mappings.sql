...
VALUES
  ('temp1111-1111-1111-1111-111111111111', 'Security', 'daily', 'Daily CCTV Terminal Check', 'ตรวจสอบสภาพตู้ CCTV ประจำวัน', 1, '{"min_photos": 1, "photo_points": [{"label": "สภาพตู้ภายนอก", "point_code": "P01"}]}', 'per_type', 'cctv_terminal', 'cctv_daily_check'),
...
VALUES
  ('temp1111-1111-1111-1111-111111111111', 'cctv_terminal')
ON CONFLICT DO NOTHING;
