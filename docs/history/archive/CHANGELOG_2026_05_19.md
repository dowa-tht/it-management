# 🕒 ประวัติการเปลี่ยนแปลง (Change Logs) - Archive 2026-05-19

## 19 พฤษภาคม 2569 (19-May-2026)
- **23:43 +07:00 | PRODUCTION MIGRATION PLAYBOOK (NEW MANUAL):**
  - สร้างคู่มือ migration ใหม่ที่ [`docs/manuals/PRODUCTION_MIGRATION_PLAYBOOK.md`](docs/manuals/PRODUCTION_MIGRATION_PLAYBOOK.md) ครอบคลุม flow ย้ายระบบจาก Dev (`trush000/dowa-it-system`) ไป Production (`dowa-tht/it-management`) ทั้ง GitHub/Vercel/Supabase
  - ระบุขั้นตอนมาตรฐาน: pre-flight, code sync, db structure migration, essential seed, smoke/E2E verification และ rollback strategy
  - อัปเดตสารบัญเอกสารหลักที่ [`docs/INDEX.md`](docs/INDEX.md) ให้ลิงก์คู่มือใหม่ในหมวด Manuals & Guides
